...
import { analyzeKeyword } from '@/app/geo/actions/analyze-keyword';
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                {!isLocal ? (
                        ...
                        <TooltipTrigger asChild>
                            <div className="w-full">
                                <Button
                                    variant="ghost"
                                    disabled
                                    className="w-full gap-3 justify-start px-2 py-2 font-semibold text-slate-400 opacity-50 cursor-not-allowed text-sm"
                                >
                                    <Beaker className="w-5 h-5 text-slate-400" /> Probar Conexión IAs
                                </Button>
                            </div>
                        </TooltipTrigger>
                        <TooltipContent>
                    ...
                    <DialogTrigger asChild>
                        <Button variant="ghost" className="w-full gap-3 justify-start px-2 py-2 font-semibold text-slate-300 hover:bg-slate-800/60 hover:text-slate-200 text-sm">
                            <Beaker className="w-5 h-5 text-slate-400" /> Probar Conexión IAs
                        </Button>
                    </DialogTrigger>
                )}
