...
import { getSampleDataset, getUniqueKeywords, SampleDatasetItem } from "@/data/geo/sample-dataset"
import { normalizeBrandName } from "@/lib/geo/competitors"
import SidebarMenu from "@/components/geo/SidebarMenu"
import { useRouter } from "next/navigation"
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip as RechartsTooltip, Legend, ResponsiveContainer } from "recharts"
import { getLatestDataBatch } from "@/lib/geo/strategic-report-service"
                      ...
                      {uniqueKeywords.map((kw) => {
                        ...
                        return (
                          <tr
                            ...
                            onClick={() => router.push(`/geo/cluster/${encodeURIComponent(kw)}`)}
                          >
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={evolutionData}>
                      ...
                      {uniqueKeywords.map((cluster, idx) => {
                        const colors = ['#6c29ff', '#ef713f', '#0fb882', '#d83f55', '#bdb2ff', '#f73c69', '#14b8a6', '#ffd18f'];
                        return (
                          <Line
                            key={cluster}
                            type="monotone"
