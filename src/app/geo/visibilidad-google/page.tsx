...
import { getSearchConsoleData } from "@/app/geo/actions/google-search-console"
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart data={filteredWeeklyRows}>
                            ...
                            {brandFilter !== 'non-branded' && (
                              <Bar dataKey="brandedClicks" name="Búsquedas Marca" stackId="a" fill="#6c29ff" radius={brandFilter === 'branded' ? [4, 4, 0, 0] : [0, 0, 0, 0]} />
                            )}
                            {brandFilter !== 'branded' && (
                    ...
                    <CardContent className="flex flex-col items-center">
                      ...
                      <div className="flex gap-4 mt-2">
                        <div className="flex items-center gap-2 text-xs font-medium">
                          <div className="w-3 h-3 rounded-full bg-[#6c29ff]" /> Marca
                        </div>
                        <div className="flex items-center gap-2 text-xs font-medium">
